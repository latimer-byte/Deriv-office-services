...
const BASE_TICKETS: Record<string, Ticket[]> = {
  "Cyberjaya, Malaysia (HQ)": [
    {
      ...
      date: "8 Jul 2024", staffName: "Ali Hassan", staffId: "EMP-03812",
      assetTag: "EMP-IT-00421", assetModel: "Dell UltraSharp U2722D",
    ...
    },
    {
      ...
      date: "7 Jul 2024", staffName: "Mei Lin Chong", staffId: "EMP-02156",
      assetTag: "", assetModel: "",
    ...
    },
    {
      ...
      date: "5 Jul 2024", staffName: "Raj Patel", staffId: "EMP-01944",
      assetTag: "EMP-IT-00318", assetModel: "HP LaserJet Pro M404dn",
    ...
    },
    {
      ...
      date: "10 Jul 2024", staffName: "Farah Zubairi", staffId: "EMP-04103",
      assetTag: "", assetModel: "",
    ...
    },
    {
      ...
      date: "9 Jul 2024", staffName: "Nurul Aina", staffId: "EMP-03701",
      assetTag: "", assetModel: "",
    ...
    },
    {
      ...
      date: "9 Jul 2024", staffName: "Hafiz Razak", staffId: "EMP-02867",
      assetTag: "", assetModel: "",
    ...
    },
    {
      ...
      date: "10 Jul 2024", staffName: "Ben Oduya", staffId: "EMP-04420",
      assetTag: "", assetModel: "",
      description: "Received an email purporting to be from Corporate IT asking me to reset my password via an external link. I did not click it. Forwarding to IT now.",
    ...
    },
    {
      ...
      date: "6 Jul 2024", staffName: "Siti Mariam", staffId: "EMP-03215",
      assetTag: "", assetModel: "",
  ...
  "Labuan, Malaysia": [
    { id: "REQ-2024-010", title: "VPN access failing after Windows update", category: "Network / VPN", dept: "IT Admin", priority: "High", status: "In Progress", location: "Level 1 — Open Plan", desk: "Desk 1-05", date: "9 Jul 2024", staffName: "Yong Kiat", staffId: "EMP-02201", assetTag: "EMP-IT-00510", assetModel: "Lenovo ThinkPad X1 Carbon", description: "VPN stopped working after Windows forced an update last night. Can't access internal systems.", technician: "Sarah Tan", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Sarah Tan", time:"9 Jul, 08:30", note:"Investigating update conflict with Cisco AnyConnect." }, { type:"comment", by:"Sarah Tan", time:"9 Jul, 10:00", note:"Rollback patch being tested in staging. Will deploy if successful.", internal:true }] },
    { id: "REQ-2024-011", title: "Water dispenser leaking near reception", category: "Plumbing / Water", dept: "Facilities Management", priority: "High", status: "Open", location: "Ground Floor — Reception", desk: "", date: "10 Jul 2024", staffName: "Linda Chin", staffId: "EMP-02890", assetTag: "", assetModel: "", description: "The water dispenser by reception is dripping constantly. The floor is getting slippery.", technician: "Unassigned", thread: [{ type:"status", from:"Submitted", to:"Submitted", by:"System", time:"10 Jul, 09:00", note:"Awaiting assignment." }] },
    { id: "REQ-2024-012", title: "Stationery restock — Level 1 supply cabinet", category: "Office Supplies", dept: "Office Admin", priority: "Low", status: "Resolved", location: "Level 1 — Supply Cabinet", desk: "", date: "6 Jul 2024", staffName: "Omar Haji", staffId: "EMP-01755", assetTag: "", assetModel: "", description: "Pens and A4 paper completely depleted.", technician: "David Lim", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"David Lim", time:"7 Jul, 10:00", note:"Stationery delivered and stocked." }] },
  ],
  "Ipoh, Malaysia": [
    { id: "REQ-2024-020", title: "Projector bulb replacement needed in training room", category: "AV Equipment", dept: "IT Admin", priority: "Medium", status: "In Progress", location: "Floor 1 — Training Room", desk: "", date: "8 Jul 2024", staffName: "Kavitha Suresh", staffId: "EMP-03102", assetTag: "EMP-IT-00222", assetModel: "Epson EB-S41", description: "Projector shows 'Lamp hours exceeded' warning. Image is very dim.", technician: "James Okonkwo", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"James Okonkwo", time:"8 Jul, 09:00", note:"" }, { type:"comment", by:"James Okonkwo", time:"8 Jul, 10:00", note:"Bulb ordered from supplier. Arriving tomorrow.", internal:false }] },
    { id: "REQ-2024-021", title: "Loose carpet tile near stairwell — trip hazard", category: "Safety / Hazard", dept: "Facilities Management", priority: "High", status: "Assigned", location: "Floor 1 — Stairwell B", desk: "", date: "10 Jul 2024", staffName: "Ahmad Fadzli", staffId: "EMP-04001", assetTag: "", assetModel: "", description: "A carpet tile has come loose near Stairwell B and is a clear trip hazard.", technician: "Aisha Kamara", thread: [{ type:"status", from:"Submitted", to:"Assigned", by:"Aisha Kamara", time:"10 Jul, 08:45", note:"Taped down temporarily. Permanent repair booked." }] },
  ],
  "Melaka, Malaysia": [
    { id: "REQ-2024-030", title: "Wi-Fi dropping on Floor 2 intermittently", category: "Network / Wi-Fi", dept: "IT Admin", priority: "Medium", status: "In Progress", location: "Floor 2 — Open Plan", desk: "", date: "7 Jul 2024", staffName: "Lim Boon Keat", staffId: "EMP-02503", assetTag: "", assetModel: "", description: "Wi-Fi drops for everyone on Floor 2 about every 20 minutes. Reconnects after 1–2 minutes.", technician: "Sarah Tan", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Sarah Tan", time:"7 Jul, 11:00", note:"" }, { type:"comment", by:"Sarah Tan", time:"7 Jul, 14:00", note:"Access point firmware updated. Monitoring for stability.", internal:false }] },
    { id: "REQ-2024-031", title: "Broken window blind in meeting room", category: "Facilities / Fixtures", dept: "Facilities Management", priority: "Low", status: "Resolved", location: "Floor 1 — Meeting Room A", desk: "", date: "5 Jul 2024", staffName: "Nurul Huda", staffId: "EMP-02211", assetTag: "", assetModel: "", description: "The roller blind in Meeting Room A won't roll back up.", technician: "Tom Reyes", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"Tom Reyes", time:"6 Jul, 11:00", note:"Blind mechanism replaced." }] },
  ],
  "Limassol, Cyprus": [
    { id: "REQ-2024-040", title: "Server room temperature alert", category: "Infrastructure", dept: "IT Admin", priority: "Critical", status: "Assigned", location: "Ground Floor — Data Centre", desk: "", date: "10 Jul 2024", staffName: "Nikos Papadopoulos", staffId: "EMP-05012", assetTag: "EMP-IT-00701", assetModel: "APC Cooling Unit CR020", description: "Temperature monitoring dashboard showing 34°C in the server room. Threshold is 28°C.", technician: "Priya Nair", thread: [{ type:"status", from:"Submitted", to:"Assigned", by:"Priya Nair", time:"10 Jul, 06:55", note:"Critical escalation. On-site within 30 mins." }, { type:"comment", by:"Priya Nair", time:"10 Jul, 07:30", note:"Cooling unit fan seized. Emergency bypass enabled. Monitoring.", internal:true }] },
    { id: "REQ-2024-041", title: "Slippery floor near fire exit", category: "Safety / Hazard", dept: "Facilities Management", priority: "Critical", status: "In Progress", location: "Floor 1 — Fire Exit Corridor", desk: "", date: "10 Jul 2024", staffName: "Elena Georgiou", staffId: "EMP-04788", assetTag: "", assetModel: "", description: "The floor by the fire exit is very slippery after the cleaner used the wrong product. Someone nearly fell.", technician: "Peter Müller", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Peter Müller", time:"10 Jul, 08:00", note:"Warning signs placed immediately. Deep clean with correct product underway." }] },
    { id: "REQ-2024-042", title: "Meeting room AV setup for all-hands call", category: "Meeting Rooms", dept: "Office Admin", priority: "High", status: "Resolved", location: "Floor 3 — Conference Suite", desk: "", date: "8 Jul 2024", staffName: "Stavros Andreou", staffId: "EMP-03345", assetTag: "", assetModel: "", description: "Need the conference suite fully set up for an all-hands video call — camera, mics, screen sharing tested.", technician: "Yuki Tanaka", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"Yuki Tanaka", time:"8 Jul, 17:00", note:"AV fully configured and tested. Call ran without issues." }] },
    { id: "REQ-2024-043", title: "MFA reset required for returning employee", category: "Access / Security", dept: "IT Admin", priority: "Medium", status: "Resolved", location: "Floor 1 — HR Area", desk: "", date: "7 Jul 2024", staffName: "Maria Constantinou", staffId: "EMP-01830", assetTag: "", assetModel: "", description: "Employee returning from parental leave — MFA authenticator app no longer linked to their account.", technician: "James Okonkwo", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"James Okonkwo", time:"7 Jul, 15:00", note:"MFA reset completed. User confirmed access restored." }] },
  ],
  "Nicosia, Cyprus": [
    { id: "REQ-2024-050", title: "New hire laptop setup — engineering team", category: "Hardware", dept: "IT Admin", priority: "High", status: "In Progress", location: "Floor 12 — Engineering Wing", desk: "", date: "9 Jul 2024", staffName: "Christos Ioannou", staffId: "EMP-05201", assetTag: "EMP-IT-00890", assetModel: "MacBook Pro 14\" M3", description: "3 new engineers starting Monday. Need MacBooks configured with dev tools, GitHub access, and VPN.", technician: "Sarah Tan", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Sarah Tan", time:"9 Jul, 09:00", note:"" }, { type:"comment", by:"Sarah Tan", time:"9 Jul, 15:00", note:"2 of 3 laptops configured. Final unit awaiting IT security approval.", internal:false }] },
    { id: "REQ-2024-051", title: "Standing desk motor not working", category: "Furniture / Fixtures", dept: "Facilities Management", priority: "Medium", status: "Submitted", location: "Floor 12 — Open Plan", desk: "Desk 12-08", date: "10 Jul 2024", staffName: "Anna Petrou", staffId: "EMP-05104", assetTag: "EMP-FAC-00214", assetModel: "Flexispot E7 Standing Desk", description: "The electric motor on my standing desk stopped responding. Control panel shows no lights.", technician: "Unassigned", thread: [{ type:"status", from:"Submitted", to:"Submitted", by:"System", time:"10 Jul, 11:00", note:"Awaiting assignment." }] },
    { id: "REQ-2024-052", title: "GitHub access for new DevOps engineer", category: "Software Access", dept: "IT Admin", priority: "Medium", status: "In Progress", location: "Floor 12 — Engineering", desk: "", date: "9 Jul 2024", staffName: "Demetrios Vasiliou", staffId: "EMP-05198", assetTag: "", assetModel: "", description: "New DevOps engineer needs access to core-services org on GitHub, including infra and deployment repos.", technician: "Priya Nair", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Priya Nair", time:"9 Jul, 13:00", note:"" }, { type:"comment", by:"Priya Nair", time:"9 Jul, 14:30", note:"Access provisioned for public repos. Restricted repos require team-lead approval — request sent.", internal:false }] },
  ],
  "Birkirkara, Malta": [
    { id: "REQ-2024-060", title: "Outlook calendar sync broken for 3 users", category: "Software / M365", dept: "IT Admin", priority: "High", status: "Assigned", location: "Level 3 — Finance Team", desk: "", date: "10 Jul 2024", staffName: "Marco Borg", staffId: "EMP-04601", assetTag: "", assetModel: "", description: "Three members of the finance team can't see shared calendars or meeting invites in Outlook since this morning.", technician: "James Okonkwo", thread: [{ type:"status", from:"Submitted", to:"Assigned", by:"James Okonkwo", time:"10 Jul, 09:30", note:"Investigating M365 tenant sync issue." }] },
    { id: "REQ-2024-061", title: "Coffee machine broken — Level 3 kitchen", category: "Kitchen Appliances", dept: "Office Admin", priority: "High", status: "In Progress", location: "Level 3 — Kitchen", desk: "", date: "8 Jul 2024", staffName: "Claire Farrugia", staffId: "EMP-03890", assetTag: "EMP-ADM-00045", assetModel: "De'Longhi ECAM 450.55", description: "Coffee machine making grinding noise then shutting off. No coffee dispensed.", technician: "Clara Santos", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Clara Santos", time:"8 Jul, 10:00", note:"" }, { type:"comment", by:"Clara Santos", time:"8 Jul, 11:00", note:"Engineer contacted. Grinder unit needs replacement. Parts on order — ETA 2 days.", internal:false }] },
    { id: "REQ-2024-062", title: "Ergonomic chair replacement on medical advice", category: "Furniture / Fixtures", dept: "Office Admin", priority: "Medium", status: "Submitted", location: "Level 3 — Open Plan", desk: "Desk 3-19", date: "10 Jul 2024", staffName: "Joseph Mifsud", staffId: "EMP-04102", assetTag: "", assetModel: "", description: "My GP has recommended a lumbar-support chair due to lower back issues. HR have approved. Need Facilities to source one.", technician: "Unassigned", thread: [{ type:"status", from:"Submitted", to:"Submitted", by:"System", time:"10 Jul, 08:00", note:"Awaiting assignment." }] },
  ],
  "London, UK": [
    { id: "REQ-2024-070", title: "New Slack workspace access for contractors", category: "Software Access", dept: "IT Admin", priority: "Medium", status: "Assigned", location: "Floor 1 — Workspace", desk: "", date: "8 Jul 2024", staffName: "Sophie Clarke", staffId: "EMP-06011", assetTag: "", assetModel: "", description: "Four external contractors starting Monday need guest access to our Slack workspace (specific channels only).", technician: "Sarah Tan", thread: [{ type:"status", from:"Submitted", to:"Assigned", by:"Sarah Tan", time:"8 Jul, 14:00", note:"Setting up guest invites — will send by EOD." }] },
    { id: "REQ-2024-071", title: "Broken coffee grinder in kitchen", category: "Kitchen Appliances", dept: "Office Admin", priority: "Low", status: "Submitted", location: "Floor 1 — Kitchen", desk: "", date: "10 Jul 2024", staffName: "Tom Harrington", staffId: "EMP-05877", assetTag: "EMP-ADM-00088", assetModel: "Sage BCG820BSS", description: "The coffee grinder blade has snapped. Machine won't run at all.", technician: "Unassigned", thread: [{ type:"status", from:"Submitted", to:"Submitted", by:"System", time:"10 Jul, 09:00", note:"Awaiting assignment." }] },
    { id: "REQ-2024-072", title: "Fire safety equipment annual inspection due", category: "Safety / Compliance", dept: "Facilities Management", priority: "High", status: "Assigned", location: "All Floors", desk: "", date: "7 Jul 2024", staffName: "Fiona Walsh", staffId: "EMP-05501", assetTag: "", assetModel: "", description: "Annual fire extinguisher and alarm panel inspection is overdue by 2 weeks. Compliance deadline this Friday.", technician: "Aisha Kamara", thread: [{ type:"status", from:"Submitted", to:"Assigned", by:"Aisha Kamara", time:"7 Jul, 13:00", note:"Inspection company booked for Thursday. All floors to be covered." }] },
  ],
  "Reading, UK": [
    { id: "REQ-2024-080", title: "Docking station not charging laptop", category: "Hardware", dept: "IT Admin", priority: "Medium", status: "Resolved", location: "Ground Floor — Open Plan", desk: "Desk G-14", date: "6 Jul 2024", staffName: "Amelia Cox", staffId: "EMP-05741", assetTag: "EMP-IT-00641", assetModel: "Dell WD22TB4 Thunderbolt Dock", description: "Docking station stopped charging my laptop. Also the USB-C video output isn't working.", technician: "James Okonkwo", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"James Okonkwo", time:"6 Jul, 16:00", note:"Faulty dock replaced from stock. All ports confirmed working." }] },
    { id: "REQ-2024-081", title: "Cleaning quality complaint — washrooms", category: "Cleaning", dept: "Office Admin", priority: "Medium", status: "In Progress", location: "Ground Floor — Washrooms", desk: "", date: "9 Jul 2024", staffName: "Daniel Hughes", staffId: "EMP-05812", assetTag: "", assetModel: "", description: "Washrooms have not been cleaned to standard for 3 consecutive days. Soap dispensers empty, bins overflowing.", technician: "Clara Santos", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Clara Santos", time:"9 Jul, 09:30", note:"Cleaning contractor notified. Additional deep clean scheduled for today." }] },
  ],
  "Paris, France": [
    { id: "REQ-2024-090", title: "Access badge not reading on main door", category: "Access / Security", dept: "Facilities Management", priority: "High", status: "In Progress", location: "Ground Floor — Main Entrance", desk: "", date: "9 Jul 2024", staffName: "Lucie Moreau", staffId: "EMP-07001", assetTag: "", assetModel: "", description: "My badge stopped working on the main entrance reader. Works on internal doors. Started after badge was demagnetised near phone.", technician: "Aisha Kamara", thread: [{ type:"status", from:"Submitted", to:"In Progress", by:"Aisha Kamara", time:"9 Jul, 08:30", note:"" }, { type:"comment", by:"Aisha Kamara", time:"9 Jul, 09:00", note:"Badge reprogrammed at security desk. Testing on door readers now.", internal:false }] },
    { id: "REQ-2024-091", title: "Monitor not detected after docking station update", category: "Monitor / Display", dept: "IT Admin", priority: "Medium", status: "Resolved", location: "Floor 1 — Open Plan", desk: "Desk 1-11", date: "7 Jul 2024", staffName: "Pierre Dupont", staffId: "EMP-07105", assetTag: "EMP-IT-00712", assetModel: "LG 27UK850-W", description: "After a docking station firmware update, my external monitor is no longer being detected.", technician: "Sarah Tan", thread: [{ type:"status", from:"Submitted", to:"Resolved", by:"Sarah Tan", time:"7 Jul, 15:30", note:"Display driver rolled back to previous version. Monitor recognised correctly." }] },
  ],
  "Berlin, Germany": [
...
// ─── Global Office Locations with Neon Landmarks ──────────────────────────────
      ...
      <div style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          <div style={{ display:"flex", alignItems:"center", gap:6 }}>
            ...
            <span style={{ fontFamily:F, fontWeight:800, fontSize:20, color: theme === "dark" ? "#F8FAFC" : "#181C25", letterSpacing:-0.5 }}>Apex</span>
          </div>
    ...
    <div className="bg-[#181C25] border-b border-[#2A3042] px-4 md:px-8 py-3 md:py-2.5 min-h-[56px] flex flex-row flex-wrap items-center justify-between gap-3 sticky top-0 z-20" style={{ fontFamily:F }}>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="flex items-center gap-2 cursor-pointer" onClick={onBack}>
          ...
          <span style={{ fontWeight:800, fontSize:15, color:"#fff", letterSpacing:-0.4 }}>Apex</span>
...
function NewRequest({ office, onSubmit }: { office: string; onSubmit: (newTicket: Ticket) => void }) {
  ...
  const [staffId, setStaffId] = useState("EMP-08422");
  const [email, setEmail] = useState("amir.syarif@company.com");
      ...
      <div className="p-4 sm:p-[36px]" style={{ background:C.card, borderRadius:20, border:`1.5px solid ${C.border}` }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input value={staffId} onChange={e => setStaffId(e.target.value)} placeholder="e.g. EMP-04821" style={inp} />
          </div>
          <div>
            <label style={lbl}>Email address</label>
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="staff.name@company.com" style={inp} />
          </div>
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <div>
                ...
                <div style={{ position:"relative" }}>
                  <input value={assetTagVal} onChange={e => setAssetTagVal(e.target.value.toUpperCase())} placeholder="e.g. EMP-IT-00842" style={{ ...inp, paddingLeft:42, fontFamily:"'Courier New', monospace", fontWeight:600, letterSpacing:1 }} />
                  <span style={{ position:"absolute", left:13, top:"50%", transform:"translateY(-50%)", fontSize:16 }}>🏷️</span>
                </div>
                <div style={{ fontSize:11, color:C.textMuted, marginTop:5 }}>Format: EMP-[DEPT]-[NUMBER]</div>
              </div>
...
function IncomingRequests({ tickets, deptFilter, title, office, onOpenTicket }: { tickets: Ticket[]; deptFilter: string; title: string; office: string; onOpenTicket: (t: Ticket) => void }) {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `office_services_requests_${new Date().toISOString().slice(0, 10)}.csv`);
